        ...
        <div className="relative w-full h-full flex flex-col bg-[#0a0a0a] overflow-hidden perspective-[1000px]">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                {[
                    ...
                    >
                        {icon.t === 's' ? (
                            <svg viewBox="0 0 24 24" fill="#1DB954" className="w-6 h-6 opacity-50 drop-shadow-[0_0_10px_rgba(29,185,84,0.3)]">
                            ...
                            <svg viewBox="0 0 24 24" fill="url(#ig-gradient-mini)" className="w-6 h-6 opacity-50 drop-shadow-[0_0_10px_rgba(220,39,67,0.3)]">
                                <defs>
            ...
            {/* Header Section */}
            <div className="relative z-20 pt-8 px-8 mb-4">
                <h3 className="text-2xl md:text-3xl font-black text-white leading-tight tracking-tight mb-3" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    Record-Breaking <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Song Promotions</span>
                </h3>

                {/* Trending Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-pink-500/10 to-purple-600/10 border border-pink-500/20 shadow-[0_0_15px_rgba(236,72,153,0.15)] backdrop-blur-md">
                    <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-pink-500">
                        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" fill="currentColor" />
                    </svg>
                    <span className="text-pink-100 text-[10px] font-bold tracking-wider uppercase">Viral Campaigns on Instagram</span>
                </div>
            </div>

            {/* 3D Page Container */}
            <div className="relative flex-1 flex items-center justify-center w-full px-6 pb-12">
                <AnimatePresence initial={false} custom={direction} mode="popLayout">
                    <motion.div
                        ...
                        animate="center"
                        exit="exit"
                        className="absolute w-[85%] aspect-[4/5] bg-black/40 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 flex flex-col shadow-2xl overflow-hidden"
                        style={{
                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <span className="text-white/30 font-mono text-[10px] tracking-widest">PAGE {currentPage + 1}</span>
                                <div className={`h-1 w-12 rounded-full bg-gradient-to-r ${pages[currentPage].color}`} />
                            </div>

                            {/* Song Title & Artist */}
                            <div className="mb-8">
                                <h2 className="text-3xl font-black text-white leading-none tracking-tight mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                                    {pages[currentPage].title}
                                </h2>
                                <p className="text-sm text-gray-400 font-medium">by {pages[currentPage].artist}</p>
                            </div>
                            ...
                            <div className="space-y-4 mt-auto">
                                ...
                                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                                    ...
                                    <span className="text-sm font-bold text-white font-mono">{pages[currentPage].duration}</span>
                                </div>

                                {/* Delivered */}
                                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Delivered</span>
                                    <span className="text-lg font-bold text-white font-mono text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">
                                ...
                                {/* Quality Score */}
                                <div className="flex items-center justify-between border-b border-white/5 pb-2">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Quality Score</span>
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-bold text-white font-mono">{pages[currentPage].score}</span>
                                ...
                                <div className="flex items-center justify-between pt-1">
                                    <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Trend Rank</span>
                                    <span className={`text-xs font-bold px-2 py-1 rounded bg-gradient-to-r ${pages[currentPage].color} bg-opacity-20 text-white`}>
                        ...
                        <div className={`absolute -top-20 -right-20 w-64 h-64 bg-gradient-to-br ${pages[currentPage].color} opacity-10 blur-[80px] rounded-full pointer-events-none`} />
                        <div className={`absolute -bottom-20 -left-20 w-64 h-64 bg-gradient-to-tr ${pages[currentPage].color} opacity-10 blur-[80px] rounded-full pointer-events-none`} />
                    </motion.div>
                </AnimatePresence>
            </div>
            ...
            <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-4 z-20">
                <button
                    onClick={prevPage}
                    className="w-10 h-10 rounded-full bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white/70 hover:bg-white/10 hover:text-white hover:scale-110 transition-all active:scale-95"
                >
    ...
    return (
        <section ref={sectionRef} className="relative py-32 px-6 bg-black overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-purple-900/20 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="mb-20">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-400 font-semibold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <Card3D glowColor="from-pink-600/30 via-purple-600/30 to-orange-600/30" className="border-pink-500/20 hover:border-pink-400/50 transition-all duration-500 ease-out group/card h-[600px]">
                        ...
                        <div className="p-8 flex-1 flex flex-col relative overflow-hidden z-10 h-full">
                                        ...
                                        <AnimatePresence mode="wait">
                                            {hoveredStat !== 'winadda' ? (
                                                ...
                                                >
                                                    ...
                                                    <br />
                                                    <span className="text-2xl md:text-3xl font-bold text-white/90 mt-1 block" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
                    ...
                    <Card3D glowColor="from-blue-600/30 via-purple-600/30 to-pink-600/30" className="h-[600px] relative overflow-hidden group/repost">
                        ...
                        {/* Content Container - Strict 32px Margin/Padding (Top 40px as requested) */}
                        <div className="relative z-10 h-full flex flex-col px-8 pb-8 pt-10">

                            {/* 1. CARD TITLE SECTION */}
                            <div className="text-center mb-4">
                                <h3 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 tracking-tight uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                            ...
                            {/* 2. TOP BRAND STRIP */}
                            <div className="relative w-full bg-white/5 border border-white/10 rounded-xl p-4 mb-4 overflow-hidden group/strip">
                                ...
                                <div className="flex flex-col items-center justify-center relative z-10 w-full">
                                    <h4 className="text-xl font-black text-white tracking-wider uppercase flex items-center gap-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                                        SAMSUNG <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-500 text-2xl">×</span> YT SHORTS
                                    </h4>
                            ...
                            <div className="flex-1 flex flex-col gap-4 overflow-hidden">
                                ...
                                <div className="grid grid-cols-2 gap-2 flex-grow">
                                    {[
                                        ...
                                        <div key={i} className="bg-white/5 rounded-lg p-2 flex flex-col items-center justify-center text-center hover:bg-white/10 transition-colors h-full border border-white/5">
                                            <span className="text-lg font-bold text-white mb-0.5">{stat.val}</span>
                                ...
                                <div className="grid grid-cols-3 gap-2 flex-shrink-0">
                                    {[
                                        ...
                                        >
                                            <span className="text-[8px] text-gray-400 uppercase mb-0.5 leading-tight tracking-wide">{badge.title}</span>
                                            <span className="text-xs font-bold text-white">{badge.val}</span>
                                        </motion.div>
                                    ))}
                                </div>
                            </div>
