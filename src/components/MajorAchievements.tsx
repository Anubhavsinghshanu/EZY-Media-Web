            ...
            <div className="relative flex-1 flex items-center justify-center w-full px-3 md:px-6 pb-8 md:pb-12">
                <AnimatePresence initial={false} custom={direction} mode="popLayout">
                    <motion.div
                        ...
                        animate="center"
                        exit="exit"
                        className="absolute w-[95%] md:w-[85%] h-[380px] md:h-auto md:aspect-[4/5] bg-black/40 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 md:p-6 flex flex-col shadow-2xl overflow-hidden"
                        style={{
...
export default function MajorAchievements() {
    ...
    return (
        <section ref={sectionRef} className="relative py-16 md:py-20 px-4 md:px-6 overflow-hidden">
            {/* Background Ambience */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <Card3D glowColor="from-red-600/20 to-orange-900/20" className="min-h-[500px] md:h-[600px] group/book-card">
                        <SongPromotionBook />
                    </Card3D>
